...
socket.on('onUserList', function (data) {
    ...
    for (var key in data) {
        if(data[key].id != socketId){
            count++;
            userListHtml += '<div class="adchkbox" style="width:300px;display:-moz-inline-box;float:right;">';
            userListHtml += '<input checked onChange="adminControl(\''+data[key].id+'\',\'doc\')" id="'+data[key].id+'_doc" type="checkbox" class="pull-right" style="margin-right:13px;">';
            userListHtml += '<input checked onChange="adminControl(\''+data[key].id+'\',\'chat\')" id="'+data[key].id+'_chat" type="checkbox" class="pull-right" style="margin-right:13px;">';
            userListHtml += '<input checked onChange="adminControl(\''+data[key].id+'\',\'cam\')" id="'+data[key].id+'_cam" type="checkbox" class="pull-right" style="margin-right:13px;">';
             userListHtml += '<input checked onChange="adminControl(\''+data[key].id+'\',\'mic\')"  id="'+data[key].id+'_mic"  type="checkbox" class="pull-right" style="margin-right:6px;">';
...
$('document').ready(function(){
          ...
          $('#cam-close').click(function(){
            ...
            if(camenable == 1){
               ...
               $('#cam-close-but').show();
               //$('#layout').hide(1000);
               //var dwidth = $(window).width()-450;
               //$('#presentation').attr('style','width:750px;right:230px;').show(1000);
               ...
               $('#cam-close-but').hide();
               //$('#layout').show(1000);
              // $('#presentation').attr('style','width:500px;right:230px;');
